const SIZE_DEFS = {
	...
	'createbigcannons:powder_charge': ['huge', 'very_heavy'],
	'createbigcannons:big_cartridge': ['huge', 'very_heavy'],
	...
	'createbigcannons:mortar_stone': ['large', 'very_heavy'],
	'createbigcannons:bag_of_grapeshot': ['large', 'very_heavy'],
	'createbigcannons:he_shell': ['huge', 'very_heavy'],
	'createbigcannons:ap_shell': ['huge', 'very_heavy'],
	'createbigcannons:shrapnel_shell': ['huge', 'very_heavy'],
	'createbigcannons:fluid_shell': ['huge', 'very_heavy'],
	'createbigcannons:smoke_shell': ['large', 'very_heavy'],
	'createbigcannons:drop_mortar_shell': ['large', 'heavy'],
	'createbigcannons:ap_shot': ['huge', 'very_heavy'],
	'createbigcannons:solid_shot': ['huge', 'very_heavy'],

	'supplementaries:safe': ['huge', 'very_heavy'],
	'minecraft:gunpowder': ['small', 'light'],

	'terrafirmacivilizations:copper_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:gold_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:silver_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:tin_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:bismuth_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:nickel_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:iron_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:zinc_mantle_chunk' : ['large', 'very_heavy'],
	'terrafirmacivilizations:cryolite_mantle_chunk' : ['large', 'very_heavy'],
};
