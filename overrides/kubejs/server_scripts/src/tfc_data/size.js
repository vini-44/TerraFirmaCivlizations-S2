const SIZE_DEFS = {
	...
	'createbigcannons:mortar_stone': ['huge', 'very_heavy'],
	'createbigcannons:bag_of_grapeshot': ['huge', 'very_heavy'],
	...
	'createbigcannons:smoke_shell': ['huge', 'very_heavy'],
	'createbigcannons:drop_mortar_shell': ['huge', 'heavy'],
	...
	'terrafirmacivilizations:copper_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:gold_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:silver_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:tin_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:bismuth_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:nickel_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:iron_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:zinc_mantle_chunk' : ['huge', 'very_heavy'],
	'terrafirmacivilizations:cryolite_mantle_chunk' : ['huge', 'very_heavy'],
};
